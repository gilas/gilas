...
(1, 'Site', 'Name', 'بیگ آی تی بلاگ', 'عنوان سایت', '1391-09-15 16:01:09'),
(2, 'Site', 'Keywords', 'گیلاس,سیستم مدیریت محتوای فارسی,کیک پی اچ پی,CMS,CakePHP,Gilas', 'توضیحات', '1391-09-15 16:01:09'),
(3, 'Site', 'Description', 'سیستم مدیریت محتوای گیلاس تولید شده در دپارتمان وب شرکت اندیشه نوین', 'توضیحات', '1391-09-15 16:01:09'),
(4, 'Site', 'FootNote', 'کلیه حقوق مادی و معنوی این نرم افزار متعلق به شرکت اندیشه نوین می باشد.', 'پانویس', '1391-09-15 16:01:09'),
(5, 'Site', 'AdminAddress', 'admin', 'آدرس مدیریت', '1391-09-15 16:01:09'),
...
CREATE TABLE IF NOT EXISTS `yg_user_informations` (
  ...
  `cod_rahgiri` varchar(20) NOT NULL,
